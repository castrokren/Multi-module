...
# Try to import adaptive processor
try:
...
class ExcelFileHandler(FileSystemEventHandler):
    ...
    def __init__(self):
        ...
        # Use adaptive processor if available and configured
        use_adaptive = config.get('use_adaptive_processor', False)
        ...
        if use_adaptive and ADAPTIVE_AVAILABLE:
            ...
            if use_adaptive and not ADAPTIVE_AVAILABLE:
                servicemanager.LogInfoMsg("[Init] Adaptive processor requested but not available, using standard processor")
