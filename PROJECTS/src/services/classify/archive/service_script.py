# ARCHIVED 2026-05-07
# Standalone win32 service with hardcoded config, superseded by simple_monitor.py.
...
SCRIPT_PATH = os.environ.get('SCRIPT_PATH', r"C:\Projects\Crawler\PROJECTS\src\services\classify\classify_and_clean_dynamic.py")
