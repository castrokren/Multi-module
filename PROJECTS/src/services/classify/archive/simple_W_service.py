# ARCHIVED - 2026-06-16
# This file is deprecated. Use v2_monitor/run_monitor_service.py instead.
# simple_W_service.py has been consolidated into the unified service launcher in v2_monitor/

"""
Simplified Windows service for monitoring Excel files.
Uses AdaptiveExcelProcessor and Config system.

DEPRECATED: Use v2_monitor.run_monitor_service instead.
"""
...
if __name__ == '__main__':
    ...
    print("ERROR: simple_W_service.py is deprecated.")
