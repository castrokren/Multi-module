...
class ServiceGUI(tk.Tk):
    ...
    def _build_ui(self):
        ...
        ToolTip(test_btn, "Test the monitor configuration. Processes first unprocessed Excel file found in watch directory.")
    ...
    def _test_config(self):
        """
        Test the monitor configuration by processing a sample file using FileMonitor.
        REFACTORED v2: Uses FileMonitor from v2_monitor instead of direct processor.
        """
        ...
        if not test_files:
            if all_files:
                ...
                messagebox.showwarning("No Test Files",
                    "All files are already processed (contain '_labeled' in name).\n"
                    "Please use an unprocessed Excel file for testing.")
            else:
                messagebox.showwarning("No Test Files", "No Excel files found in watch directory.")
            return
        ...
        try:
            ...
            # Create temporary monitor just for testing
            monitor = FileMonitor(
            ...
            # Initialize processor and test file
            monitor._initialize_processor()
            self._log_message("Processing test file...")
            ...
            if success:
                ...
                messagebox.showerror("Test Failed",
                    f"Failed to process: {test_file.name}\n"
    ...
    def _show_learning_report(self):
        ...
        try:
            ...
            messagebox.showerror("Missing Module", "Adaptive processor module not found.")
        except Exception as e:
    ...
    def _show_about(self):
        ...
        messagebox.showinfo("About",
            "Folder Monitor Service Manager v2\n\n"
