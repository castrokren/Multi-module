...
def debug_adaptive_processor():
    ...
    try:
        ...
        print("   [OK] AdaptiveExcelProcessor imported successfully")
    ...
    try:
        ...
        print("   [OK] Adaptive processor created successfully")
        print(f"   [OK] Loaded {len(processor.hw_keywords)} HW keywords")
        print(f"   [OK] Loaded {len(processor.sw_keywords)} SW keywords")
    ...
    try:
        ...
        print(f"   [OK] Excel file read successfully: {len(df)} rows, {len(df.columns)} columns")
        print(f"   Columns: {list(df.columns)}")
        
        # Find description column
        print("   Finding description column...")
        desc_col = processor.find_description_column(df)
        print(f"   [OK] Description column found: '{desc_col}'")
        ...
        if success:
            print("   [OK] File processing successful!")
...
def test_specific_file(file_path):
    ...
    try:
        ...
        if success:
            print("[OK] SUCCESS: File processed successfully")
            return True
        else:
