...
def main():
    ...
    try:
        ...
        print(f"[ROCKET] Starting ULTRA-SAFE test with {test_dir}")
        ...
        if success:
            ...
            print("[WARNING]️ ULTRA-SAFE test completed (no matches expected with test data)")
            
    except Exception as e:
        print(f"[ERROR] ULTRA-SAFE test error: {e}")
    finally:
        signal.alarm(0)
