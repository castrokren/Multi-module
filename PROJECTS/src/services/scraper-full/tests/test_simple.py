...
for file in files_to_check:
    ...
    status = '✅ EXISTS' if exists else '[ERROR] NOT FOUND'
    print(f"  {file}: {status}")
    with open('test_output.txt', 'a') as f:
...
try:
    ...
    print(f"  pandas: [ERROR] ERROR - {e}")
    with open('test_output.txt', 'a') as f:
        f.write(f"  pandas: [ERROR] ERROR - {e}\n")
        f.flush()
...
try:
    ...
    print(f"  PyPDF2: [ERROR] ERROR - {e}")
    with open('test_output.txt', 'a') as f:
        f.write(f"  PyPDF2: [ERROR] ERROR - {e}\n")
        f.flush()
...
try:
    ...
    print(f"  pdfplumber: [ERROR] ERROR - {e}")
    with open('test_output.txt', 'a') as f:
        f.write(f"  pdfplumber: [ERROR] ERROR - {e}\n")
        f.flush()
...
try:
    ...
    print(f"  CrossReferenceEngine: [ERROR] ERROR - {e}")
    with open('test_output.txt', 'a') as f:
        f.write(f"  CrossReferenceEngine: [ERROR] ERROR - {e}\n")
        f.flush()
