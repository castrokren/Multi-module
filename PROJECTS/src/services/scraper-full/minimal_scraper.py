...
def test_basic_functionality():
    ...
    try:
        ...
        print(f"[ERROR] pandas missing: {e}")
        return False
    ...
    try:
        ...
        print(f"[ERROR] requests missing: {e}")
        return False
    ...
    try:
        ...
        print(f"[ERROR] BeautifulSoup missing: {e}")
        return False
    ...
    try:
        ...
        print(f"[ERROR] tkinter missing: {e}")
        return False
    ...
    try:
        ...
        if 'pdf_crawler_gui_2.py' in files:
            ...
            print("[ERROR] Main scraper file not found")
    ...
    try:
        ...
        print(f"[ERROR] Main scraper import failed: {e}")
        import traceback
        traceback.print_exc()
        return False
...
if __name__ == "__main__":
    if test_basic_functionality():
        ...
        print("[ERROR] Basic tests failed. Please fix the issues above before running the scraper.")
