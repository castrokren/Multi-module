...
def install_psutil():
    ...
    try:
        ...
        print("")
        print("[WARNING]️ The tool will still work without psutil, but with limited system monitoring")
        return False
        
    except Exception as e:
        print(f"[ERROR] Unexpected error installing psutil: {e}")
        print("")
        print("💡 Alternative installation methods:")
        print("  1. Run: pip install psutil")
        print("  2. Run: python -m pip install psutil")
...
def test_psutil():
    ...
    try:
        ...
        print("[ERROR] psutil not found - installation may have failed")
        return False
    except Exception as e:
